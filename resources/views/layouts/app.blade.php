...
<head>
    ...
    <title>Dashboard &mdash; SMK Antartika 1 Sidoarjo</title>
    <link rel="shortcut icon" href="{{ asset('assets/img/antartika1.png') }}" type="image/x-icon">
    <!-- General CSS Files -->
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html">SMK Antartika 1 Sidoarjo</a>
                    </div>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2018 <div class="bullet"></div> SMK Antartika 1 Sidoarjo <div class="bullet"></div> All Rights
                    Reserved.
                </div>
